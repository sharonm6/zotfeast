...
class _MapScreenState extends State<MapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double a = sin(dLat / 2) * sin(dLat / 2) +
        cos(_toRadians(current_latitude)) * cos(_toRadians(a_lat)) * sin(dLon / 2) * sin(dLon / 2);
    ...
    double y = sin(target_Lat / 2) * sin(target_Lat / 2) +
        cos(_toRadians(current_latitude)) * cos(_toRadians(a_lat)) * sin(target_Lon / 2) * sin(target_Lon / 2);
